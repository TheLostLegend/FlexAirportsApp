...
class RetrofitClient private constructor() {
    ...
    init {
        val retrofit: Retrofit = Retrofit.Builder().baseUrl("https://flexair-production.up.railway.app/")
        ...
        val gson = GsonBuilder()
            ...
            .create()
        val retrofit2: Retrofit = Retrofit.Builder().baseUrl("https://flexair-production.up.railway.app/")
